...
# 179
mai_179_119 <- subset(li6800_merged, id == "179" & doy == 119) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_179_119)
...
# 4265
tri_4265_120 <- subset(li6800_merged, id == "4265" & doy == 120) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(tri_4265_120)
...
# 2799
mai_2799_128 <- subset(li6800_merged, id == "2799" & doy == 128) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_2799_128)
...
# 4216
mai_4216_128 <- subset(li6800_merged, id == "4216" & doy == 128) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_4216_128)

aci_coefs[232,] <- c(id = "4216", spp = "Mai", plot = 6, subplot = 11,
                     doy = 128, t(coef(mai_4216_128)),
                     leaf_length_cm = 17.0, stem_length_cm = 53.2)

# 3438
mai_3438_128 <- subset(li6800_merged, id == "3438" & doy == 128) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_3438_128)
...
# flag8
tri_flag8_134 <- subset(li6800_merged, id == "flag8" & doy == 134) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(tri_flag8_134)
...
# 3
tri_flag3_134 <- subset(li6800_merged, id == "flag3_tri" & doy == 134 & (A < 4 | A > 6)) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(tri_flag3_134)
...
# 1
tri_flag1_134 <- subset(li6800_merged, id == "flag1_tri" & doy == 134) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(tri_flag1_134)
...
# 2
tri_flag2_134 <- subset(li6800_merged, id == "flag2_tri" & doy == 134) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(tri_flag2_134)
...
# 2
mai_flag2_134 <- subset(li6800_merged, id == "flag2_mai" & doy == 134) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_flag2_134)
...
# 4250
mai_4250_151 <- subset(li6800_merged, id == "4250" & doy == 151 & (A < 2 | A > 6)) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
plot(mai_4250_151)
...
# TT24_232
mai_TT24_232_159 <- subset(li6800_merged, id == "TT24_232" & doy == 159 & (A < 4 | A > 8)) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
...
# 5178
mai_5178_165 <- subset(li6800_merged, id == "5178" & doy == 165) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5178_165)
...
# 6495
mai_6495_165 <- subset(li6800_merged, id == "6495" & doy == 165) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_6495_165)

aci_coefs[647, ] <- c(id = "6495", spp = "Mai", plot = 6, subplot = 25,
                      doy = 165, t(coef(mai_6495_165)),
                      leaf_length_cm = 20.0, stem_length_cm = 60.1)

# 5600
mai_5600_165 <- subset(li6800_merged, id == "5600" & doy == 165) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5600_165)

aci_coefs[648, ] <- c(id = "5600", spp = "Mai", plot = 6, subplot = 32,
                      doy = 165, t(coef(mai_5600_165)),
                      leaf_length_cm = 20.1, stem_length_cm = 67.5)

# 5579
mai_5579_165 <- subset(li6800_merged, id == "5579" & doy == 165) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5579_165)

aci_coefs[649, ] <- c(id = "5579", spp = "Mai", plot = 6, subplot = 25,
                      doy = 165, t(coef(mai_5579_165)),
                      leaf_length_cm = 16.5, stem_length_cm = 60.5)

# 2608
mai_2608_165 <- subset(li6800_merged, id == "2608" & doy == 165) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_2608_165)

aci_coefs[650, ] <- c(id = "2608", spp = "Mai", plot = 6, subplot = 25,
                      doy = 165, t(coef(mai_2608_165)),
                      leaf_length_cm = 15.2, stem_length_cm = 45.4)

# 4237
mai_4237_165 <- subset(li6800_merged, id == "4237" & doy == 165) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_4237_165)

aci_coefs[651, ] <- c(id = "4237", spp = "Mai", plot = 6, subplot = 32,
                      doy = 165, t(coef(mai_4237_165)),
                      leaf_length_cm = 10.5, stem_length_cm = 47.1)

# TT24_160
mai_TT24_160_165 <- subset(li6800_merged, id == "TT24_160" & doy == 165) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_160_165)

aci_coefs[652, ] <- c(id = "TT24_160", spp = "Mai", plot = 6, subplot = 32,
                      doy = 165, t(coef(mai_TT24_160_165)),
                      leaf_length_cm = 10.4, stem_length_cm = 20.0)

# TT24_161
mai_TT24_161_165 <- subset(li6800_merged, id == "TT24_161" & doy == 165) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_161_165)

aci_coefs[653, ] <- c(id = "TT24_161", spp = "Mai", plot = 6, subplot = 32,
...
aci_coefs[654, ] <- c(id = "3136", spp = "Mai", plot = 6, subplot = 32,
...
aci_coefs[655, ] <- c(id = "TT24_205", spp = "Mai", plot = 6, subplot = 34,
...
aci_coefs[656, ] <- c(id = "TT24_233", spp = "Mai", plot = 6, subplot = 36,
...
aci_coefs[657, ] <- c(id = "6448", spp = "Mai", plot = 6, subplot = 36,
...
aci_coefs[658, ] <- c(id = "6462", spp = "Mai", plot = 6, subplot = 36,
...
aci_coefs[659, ] <- c(id = "5504", spp = "Mai", plot = 6, subplot = 36,
...
aci_coefs[660, ] <- c(id = "2743", spp = "Mai", plot = 6, subplot = 36,
...
aci_coefs[661, ] <- c(id = "1467", spp = "Mai", plot = 6, subplot = 36,
...
aci_coefs[662, ] <- c(id = "2726", spp = "Mai", plot = 6, subplot = 30,
...
aci_coefs[663, ] <- c(id = "TT24_230", spp = "Mai", plot = 6, subplot = NA,
...
aci_coefs[664, ] <- c(id = "TT24_206", spp = "Mai", plot = 6, subplot = 22,
...
aci_coefs[665, ] <- c(id = "3175", spp = "Mai", plot = 6, subplot = 22,
...
aci_coefs[666, ] <- c(id = "5229", spp = "Tri", plot = 6, subplot = 1,
...
aci_coefs[667, ] <- c(id = "684", spp = "Tri", plot = 6, subplot = 2,
...
aci_coefs[668, ] <- c(id = "TT24_132", spp = "Mai", plot = 6, subplot = 2,
...
aci_coefs[669, ] <- c(id = "5742", spp = "Tri", plot = 6, subplot = 3,
...
aci_coefs[670, ] <- c(id = "978", spp = "Tri", plot = 6, subplot = 6,
...
aci_coefs[671, ] <- c(id = "striped1", spp = "Tri", plot = 6, subplot = 5,
...
aci_coefs[672, ] <- c(id = "striped2", spp = "Tri", plot = 6, subplot = 5,
...
aci_coefs[673, ] <- c(id = "TT24_104", spp = "Mai", plot = 6, subplot = 33,
...
aci_coefs[674, ] <- c(id = "TT24_105", spp = "Mai", plot = 6, subplot = 27,
                      doy = 165, t(coef(mai_TT24_105_165)),
                      leaf_length_cm = 18.0, stem_length_cm = 54.6)

#####################################################################
# 6/21/24: plot 3 (DOY = 173)
#####################################################################
unique(subset(li6800_merged, doy == 173)$id)

# TT24_212
mai_TT24_212_173 <- subset(li6800_merged, id == "TT24_212" & doy == 173) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_212_173)

aci_coefs[675, ] <- c(id = "TT24_212", spp = "Mai", plot = 3, subplot = 4,
                      doy = 173, t(coef(mai_TT24_212_173)),
                      leaf_length_cm = 16.8, stem_length_cm = 45.5)

# 1643
mai_1643_173 <- subset(li6800_merged, id == "1643" & doy == 173) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_1643_173)

aci_coefs[676, ] <- c(id = "1643", spp = "Mai", plot = 3, subplot = NA,
                      doy = 173, t(coef(mai_1643_173)),
                      leaf_length_cm = 11.2, stem_length_cm = 29.6)

# 129
mai_129_173 <- subset(li6800_merged, id == "129" & doy == 173) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_129_173)

aci_coefs[677, ] <- c(id = "129", spp = "Mai", plot = 3, subplot = 12,
                      doy = 173, t(coef(mai_129_173)),
                      leaf_length_cm = 8.1, stem_length_cm = 17.2)

# 9412
mai_9412_173 <- subset(li6800_merged, id == "9412" & doy == 173) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_9412_173)

aci_coefs[678, ] <- c(id = "9412", spp = "Mai", plot = 3, subplot = 3,
                      doy = 173, t(coef(mai_9412_173)),
                      leaf_length_cm = 15.8, stem_length_cm = 44.9)

# 4250
mai_4250_173 <- subset(li6800_merged, id == "4250" & doy == 173) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_4250_173)

aci_coefs[679, ] <- c(id = "4250", spp = "Mai", plot = 3, subplot = 2,
                      doy = 173, t(coef(mai_4250_173)),
                      leaf_length_cm = 12.1, stem_length_cm = 34.2)

# TT24_112
mai_TT24_112_173 <- subset(li6800_merged, id == "TT24_112" & doy == 173) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_112_173)

aci_coefs[680, ] <- c(id = "TT24_112", spp = "Mai", plot = 3, subplot = 2,
                      doy = 173, t(coef(mai_TT24_112_173)),
                      leaf_length_cm = 15.1, stem_length_cm = 56.5)

# 5105
mai_5105_173 <- subset(li6800_merged, id == "5105" & doy == 173) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5105_173)

aci_coefs[681, ] <- c(id = "5105", spp = "Mai", plot = 3, subplot = 8,
                      doy = 173, t(coef(mai_5105_173)),
                      leaf_length_cm = 15.2, stem_length_cm = 39.7)

# TT24_111
mai_TT24_111_173 <- subset(li6800_merged, id == "TT24_111" & doy == 173) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_111_173)

aci_coefs[682, ] <- c(id = "TT24_111", spp = "Mai", plot = 3, subplot = NA,
                      doy = 173, t(coef(mai_TT24_111_173)),
                      leaf_length_cm = 16.6, stem_length_cm = 53.2)

# TT24_110
mai_TT24_110_173 <- subset(li6800_merged, id == "TT24_110" & doy == 173) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_110_173)

aci_coefs[683, ] <- c(id = "TT24_110", spp = "Mai", plot = 3, subplot = NA,
                      doy = 173, t(coef(mai_TT24_110_173)),
                      leaf_length_cm = 17.8, stem_length_cm = 45.4)

# 141
mai_141_173 <- subset(li6800_merged, id == "141" & doy == 173) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_141_173)

aci_coefs[684, ] <- c(id = "141", spp = "Mai", plot = 3, subplot = 13,
                      doy = 173, t(coef(mai_141_173)),
                      leaf_length_cm = 16.3, stem_length_cm = 44.1)

# 5184
mai_5184_173 <- subset(li6800_merged, id == "5184" & doy == 173) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
plot(mai_5184_173)

aci_coefs[685, ] <- c(id = "5184", spp = "Mai", plot = 3, subplot = 13,
                      doy = 173, t(coef(mai_5184_173)),
                      leaf_length_cm = 16.3, stem_length_cm = 40.9)
...
#####################################################################
# 1476
mai_1476_173 <- subset(li6800_merged, id == "1476" & doy == 173) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_1476_173)

aci_coefs[686, ] <- c(id = "1476", spp = "Mai", plot = 5, subplot = 23,
                      doy = 173, t(coef(mai_1476_173)),
                      leaf_length_cm = 9.6, stem_length_cm = 24.6)

# 4781
mai_4781_173 <- subset(li6800_merged, id == "4781" & doy == 173) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_4781_173)

aci_coefs[687, ] <- c(id = "4781", spp = "Mai", plot = 5, subplot = 23,
                      doy = 173, t(coef(mai_4781_173)),
                      leaf_length_cm = 17.4, stem_length_cm = 66.1)

# 5657
mai_5657_173 <- subset(li6800_merged, id == "5657" & doy == 173) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5657_173)

aci_coefs[688, ] <- c(id = "5657", spp = "Mai", plot = 5, subplot = 23,
                      doy = 173, t(coef(mai_5657_173)),
                      leaf_length_cm = 17.0, stem_length_cm = 57.2)

# 1499
mai_1499_173 <- subset(li6800_merged, id == "1499" & doy == 173) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_1499_173)

aci_coefs[689, ] <- c(id = "1499", spp = "Mai", plot = 5, subplot = 17,
                      doy = 173, t(coef(mai_1499_173)),
                      leaf_length_cm = 19.2, stem_length_cm = 73.1)

# 1432
mai_1432_173 <- subset(li6800_merged, id == "1432" & doy == 173) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_1432_173)

aci_coefs[690, ] <- c(id = "1432", spp = "Mai", plot = 5, subplot = 17,
                      doy = 173, t(coef(mai_1432_173)),
                      leaf_length_cm = 19.0, stem_length_cm = 79.6)

# 2803
mai_2803_173 <- subset(li6800_merged, id == "2803" & doy == 173) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_2803_173)

aci_coefs[691, ] <- c(id = "2803", spp = "Mai", plot = 5, subplot = 18,
                      doy = 173, t(coef(mai_2803_173)),
                      leaf_length_cm = 15.2, stem_length_cm = 47.6)

# 631
mai_631_173 <- subset(li6800_merged, id == "631" & doy == 173) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_631_173)

aci_coefs[692, ] <- c(id = "631", spp = "Mai", plot = 5, subplot = 3,
                      doy = 173, t(coef(mai_631_173)),
                      leaf_length_cm = 17.1, stem_length_cm = 66.8)

# 3960
mai_3960_173 <- subset(li6800_merged, id == "3960" & doy == 173) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_3960_173)

aci_coefs[693, ] <- c(id = "3960", spp = "Mai", plot = 5, subplot = 3,
                      doy = 173, t(coef(mai_3960_173)),
                      leaf_length_cm = 18.3, stem_length_cm = 61.8)

# 3993
mai_3993_173 <- subset(li6800_merged, id == "3993" & doy == 173) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_3993_173)

aci_coefs[694, ] <- c(id = "3993", spp = "Mai", plot = 5, subplot = 3,
                      doy = 173, t(coef(mai_3993_173)),
                      leaf_length_cm = 16.6, stem_length_cm = 46.5)

# flag3_mai
mai_flag3_mai_173 <- subset(li6800_merged, id == "flag3_mai" & doy == 173) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
plot(mai_flag3_mai_173)

aci_coefs[695, ] <- c(id = "flag3_mai", spp = "Mai", plot = 5, subplot = 3,
                      doy = 173, t(coef(mai_flag3_mai_173)),
                      leaf_length_cm = 12.1, stem_length_cm = 23.1)

#####################################################################
# 6/22/24: plot 6 (DOY = 174)
#####################################################################
unique(subset(li6800_merged, doy == 174)$id)

# TT24_150
mai_TT24_150_174 <- subset(li6800_merged, id == "TT24_150" & doy == 174) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_150_174)

aci_coefs[696, ] <- c(id = "TT24_150", spp = "Mai", plot = 6, subplot = 19,
                      doy = 174, t(coef(mai_TT24_150_174)),
                      leaf_length_cm = 18.4, stem_length_cm = 63.9)

# 6483
mai_6483_174 <- subset(li6800_merged, id == "6483" & doy == 174) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_6483_174)

aci_coefs[697, ] <- c(id = "6483", spp = "Mai", plot = 6, subplot = 19,
                      doy = 174, t(coef(mai_6483_174)),
                      leaf_length_cm = 15.6, stem_length_cm = 49.1)

# 1941
mai_1941_174 <- subset(li6800_merged, id == "1941" & doy == 174) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_1941_174)

aci_coefs[698, ] <- c(id = "1941", spp = "Mai", plot = 6, subplot = 19,
                      doy = 174, t(coef(mai_1941_174)),
                      leaf_length_cm = 15.6, stem_length_cm = 46.6)

# TT24_135
mai_TT24_135_174 <- subset(li6800_merged, id == "TT24_135" & doy == 174) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_135_174)

aci_coefs[699, ] <- c(id = "TT24_135", spp = "Mai", plot = 6, subplot = 20,
                      doy = 174, t(coef(mai_TT24_135_174)),
                      leaf_length_cm = 16.1, stem_length_cm = 59.0)

# 2692
mai_2692_174 <- subset(li6800_merged, id == "2692" & doy == 174) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_2692_174)

aci_coefs[700, ] <- c(id = "2692", spp = "Mai", plot = 6, subplot = 21,
                   doy = 174, t(coef(mai_2692_174)),
                   leaf_length_cm = 17.9, stem_length_cm = 52.8)

# 2639
mai_2639_174 <- subset(li6800_merged, id == "2639" & doy == 174) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_2639_174)

aci_coefs[701, ] <- c(id = "2639", spp = "Mai", plot = 6, subplot = 21,
                      doy = 174, t(coef(mai_2639_174)),
                      leaf_length_cm = 18.6, stem_length_cm = 62.8)

# 5506
mai_5506_174 <- subset(li6800_merged, id == "5506" & doy == 174) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5506_174)

aci_coefs[702, ] <- c(id = "5506", spp = "Mai", plot = 6, subplot = 21,
                      doy = 174, t(coef(mai_5506_174)),
                      leaf_length_cm = 13.6, stem_length_cm = 35.5)

# 2799
mai_2799_174 <- subset(li6800_merged, id == "2799" & doy == 174) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_2799_174)

aci_coefs[703, ] <- c(id = "2799", spp = "Mai", plot = 6, subplot = 14,
                      doy = 174, t(coef(mai_2799_174)),
                      leaf_length_cm = 19.0, stem_length_cm = 57.0)

# TT24_130
mai_TT24_130_174 <- subset(li6800_merged, id == "TT24_130" & doy == 174) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_130_174)

aci_coefs[704, ] <- c(id = "TT24_130", spp = "Mai", plot = 6, subplot = 8,
                      doy = 174, t(coef(mai_TT24_130_174)),
                      leaf_length_cm = 19.6, stem_length_cm = 69.5)

# 5122
mai_5122_174 <- subset(li6800_merged, id == "5122" & doy == 174) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5122_174)

aci_coefs[705, ] <- c(id = "5122", spp = "Mai", plot = 6, subplot = 2,
                      doy = 174, t(coef(mai_5122_174)),
                      leaf_length_cm = 16.4, stem_length_cm = 46.2)

# 4722
mai_4722_174 <- subset(li6800_merged, id == "4722" & doy == 174) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_4722_174)

aci_coefs[706, ] <- c(id = "4722", spp = "Mai", plot = 6, subplot = 8,
                      doy = 174, t(coef(mai_4722_174)),
                      leaf_length_cm = 18.6, stem_length_cm = 65.3)

# 1495
mai_1495_174 <- subset(li6800_merged, id == "1495" & doy == 174) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_1495_174)

aci_coefs[707, ] <- c(id = "1495", spp = "Mai", plot = 6, subplot = 8,
                      doy = 174, t(coef(mai_1495_174)),
                      leaf_length_cm = 17.4, stem_length_cm = 58.9)

# 5009
mai_5009_174 <- subset(li6800_merged, id == "5009" & doy == 174) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5009_174)

aci_coefs[708, ] <- c(id = "5009", spp = "Mai", plot = 6, subplot = 8,
                      doy = 174, t(coef(mai_5009_174)),
                      leaf_length_cm = 11.9, stem_length_cm = 29.3)

# 1146
mai_1146_174 <- subset(li6800_merged, id == "1146" & doy == 174) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_1146_174)

aci_coefs[709, ] <- c(id = "1146", spp = "Mai", plot = 6, subplot = 8,
                      doy = 174, t(coef(mai_1146_174)),
                      leaf_length_cm = 17.6, stem_length_cm = 59.7)

# TT24_131
mai_TT24_131_174 <- subset(li6800_merged, id == "TT24_131" & doy == 174) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_131_174)

aci_coefs[710, ] <- c(id = "TT24_131", spp = "Mai", plot = 6, subplot = 9,
                      doy = 174, t(coef(mai_TT24_131_174)),
                      leaf_length_cm = 19.9, stem_length_cm = 64.2)

# 5664
mai_5664_174 <- subset(li6800_merged, id == "5664" & doy == 174) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5664_174)

aci_coefs[711, ] <- c(id = "5664", spp = "Mai", plot = 6, subplot = 9,
                      doy = 174, t(coef(mai_5664_174)),
                      leaf_length_cm = 16.5, stem_length_cm = 49.9)

# 5607
mai_5607_174 <- subset(li6800_merged, id == "5607" & doy == 174) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5607_174)

aci_coefs[712, ] <- c(id = "5607", spp = "Mai", plot = 6, subplot = 9,
                      doy = 174, t(coef(mai_5607_174)),
                      leaf_length_cm = 14.5, stem_length_cm = 35.3)

# 5596
mai_5596_174 <- subset(li6800_merged, id == "5596" & doy == 174) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5596_174)

aci_coefs[713, ] <- c(id = "5596", spp = "Mai", plot = 6, subplot = 8,
                      doy = 174, t(coef(mai_5596_174)),
                      leaf_length_cm = 10.0, stem_length_cm = 23.2)

# 5567
mai_5567_174 <- subset(li6800_merged, id == "5567" & doy == 174) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5567_174)

aci_coefs[714, ] <- c(id = "5567", spp = "Mai", plot = 6, subplot = 22,
                      doy = 174, t(coef(mai_5567_174)),
                      leaf_length_cm = 19.1, stem_length_cm = 58.5)

# 6463
mai_6463_174 <- subset(li6800_merged, id == "6463" & doy == 174) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_6463_174)

aci_coefs[715, ] <- c(id = "6463", spp = "Mai", plot = 6, subplot = NA,
                      doy = 174, t(coef(mai_6463_174)),
                      leaf_length_cm = 13.1, stem_length_cm = 27.6)

# 3438
mai_3438_174 <- subset(li6800_merged, id == "3438" & doy == 174) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_3438_174)

aci_coefs[716, ] <- c(id = "3438", spp = "Mai", plot = 6, subplot = 11,
                      doy = 174, t(coef(mai_3438_174)),
                      leaf_length_cm = 19.5, stem_length_cm = 61.1)

# 4216
mai_4216_174 <- subset(li6800_merged, id == "4216" & doy == 174) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_4216_174)

aci_coefs[717, ] <- c(id = "4216", spp = "Mai", plot = 6, subplot = 11,
                      doy = 174, t(coef(mai_4216_174)),
                      leaf_length_cm = 18.1, stem_length_cm = 55.4)

# 5025
mai_5025_174 <- subset(li6800_merged, id == "5025" & doy == 174) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5025_174)

aci_coefs[718, ] <- c(id = "5025", spp = "Mai", plot = 6, subplot = 11,
                      doy = 174, t(coef(mai_5025_174)),
                      leaf_length_cm = 19.5, stem_length_cm = 66.6)

# TT24_234
mai_TT24_234_174 <- subset(li6800_merged, id == "TT24_234" & doy == 174) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_234_174)

aci_coefs[719, ] <- c(id = "TT24_234", spp = "Mai", plot = 6, subplot = 11,
                      doy = 174, t(coef(mai_TT24_234_174)),
                      leaf_length_cm = 17.5, stem_length_cm = 54.0)

# 5569
mai_5569_174 <- subset(li6800_merged, id == "5569" & doy == 174) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5569_174)

aci_coefs[720, ] <- c(id = "5569", spp = "Mai", plot = 6, subplot = 11,
                      doy = 174, t(coef(mai_5569_174)),
                      leaf_length_cm = 17.7, stem_length_cm = 48.9)

# TT24_231
mai_TT24_231_174 <- subset(li6800_merged, id == "TT24_231" & doy == 174) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_231_174)

aci_coefs[721, ] <- c(id = "TT24_231", spp = "Mai", plot = 6, subplot = 6,
                      doy = 174, t(coef(mai_TT24_231_174)),
                      leaf_length_cm = 14.4, stem_length_cm = 40.5)

# TT24_232
mai_TT24_232_174 <- subset(li6800_merged, id == "TT24_232" & doy == 174) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_232_174)

aci_coefs[722, ] <- c(id = "TT24_232", spp = "Mai", plot = 6, subplot = 12,
                      doy = 174, t(coef(mai_TT24_232_174)),
                      leaf_length_cm = 15.3, stem_length_cm = 46.8)

#####################################################################
# 6/27/24: plot 3 (DOY = 179)
#####################################################################
unique(subset(li6800_merged, doy == 179)$id)

# TT24_211
mai_TT24_211_179 <- subset(li6800_merged, id == "TT24_211" & doy == 179) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_211_179)

aci_coefs[723, ] <- c(id = "TT24_211", spp = "Mai", plot = 3, subplot = 18,
                      doy = 179, t(coef(mai_TT24_211_179)),
                      leaf_length_cm = 9.6, stem_length_cm = 14.8)

# 5069
mai_5069_179 <- subset(li6800_merged, id == "5069" & doy == 179) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5069_179)

aci_coefs[724, ] <- c(id = "5069", spp = "Mai", plot = 3, subplot = 24,
                      doy = 179, t(coef(mai_5069_179)),
                      leaf_length_cm = 13.1, stem_length_cm = 39.8)

# 5030
mai_5030_179 <- subset(li6800_merged, id == "5030" & doy == 179) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5030_179)

aci_coefs[725, ] <- c(id = "5030", spp = "Mai", plot = 3, subplot = 24,
                      doy = 179, t(coef(mai_5030_179)),
                      leaf_length_cm = 11.6, stem_length_cm = 32.9)

# 54
mai_54_179 <- subset(li6800_merged, id == "54" & doy == 179) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_54_179)

aci_coefs[726, ] <- c(id = "54", spp = "Mai", plot = 3, subplot = 16,
                      doy = 179, t(coef(mai_54_179)),
                      leaf_length_cm = 13.6, stem_length_cm = 36.6)

# 511
mai_511_179 <- subset(li6800_merged, id == "511" & doy == 179) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_511_179)

aci_coefs[727, ] <- c(id = "511", spp = "Mai", plot = 3, subplot = 30,
                      doy = 179, t(coef(mai_511_179)),
                      leaf_length_cm = 10.5, stem_length_cm = 24.9)

# 3665
mai_3665_179 <- subset(li6800_merged, id == "3665" & doy == 179) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_3665_179)

aci_coefs[728, ] <- c(id = "3665", spp = "Mai", plot = 3, subplot = 30,
                      doy = 179, t(coef(mai_3665_179)),
                      leaf_length_cm = 10.5, stem_length_cm = 24.9)

# TT24_201
mai_TT24_201_179 <- subset(li6800_merged, id == "TT24_201" & doy == 179) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_201_179)

aci_coefs[729, ] <- c(id = "TT24_201", spp = "Mai", plot = 3, subplot = 35,
                      doy = 179, t(coef(mai_TT24_201_179)),
                      leaf_length_cm = 9.4, stem_length_cm = 23.5)

# TT24_204
mai_TT24_204_179 <- subset(li6800_merged, id == "TT24_204" & doy == 179) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_204_179)

aci_coefs[730, ] <- c(id = "TT24_204", spp = "Mai", plot = 3, subplot = 35,
                      doy = 179, t(coef(mai_TT24_204_179)),
                      leaf_length_cm = 14.2, stem_length_cm = 38.0)

# TT24_102
mai_TT24_102_179 <- subset(li6800_merged, id == "TT24_102" & doy == 179 & (Ci < 250 | Ci > 500)) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_102_179)

aci_coefs[731, ] <- c(id = "TT24_102", spp = "Mai", plot = 3, subplot = 32,
                      doy = 179, t(coef(mai_3993_179)),
                      leaf_length_cm = 9.4, stem_length_cm = 21.3)

# TT24_101
mai_TT24_101_179 <- subset(li6800_merged, id == "TT24_101_b" & doy == 179 & Ci < 600) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_101_179)

aci_coefs[732, ] <- c(id = "TT24_101", spp = "Mai", plot = 3, subplot = 32,
                      doy = 179, t(coef(mai_TT24_101_179)),
                      leaf_length_cm = 14.0, stem_length_cm = 33.6)

# 1251
mai_1251_179 <- subset(li6800_merged, id == "1251" & doy == 179) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_1251_179)

aci_coefs[733, ] <- c(id = "1251", spp = "Mai", plot = 3, subplot = 33,
                      doy = 179, t(coef(mai_1251_179)),
                      leaf_length_cm = 15.9, stem_length_cm = 54.0)


#####################################################################
# 6/28/24: plot 6 (DOY = 180)
#####################################################################
unique(subset(li6800_merged, doy == 180)$id)

# 6495
mai_6495_180 <- subset(li6800_merged, id == "6495" & doy == 180) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_6495_180)

aci_coefs[734, ] <- c(id = "6495", spp = "Mai", plot = 6, subplot = 25,
                      doy = 180, t(coef(mai_6495_180)),
                      leaf_length_cm = 19.6, stem_length_cm = 63.3)

# TT24_161
mai_TT24_161_180 <- subset(li6800_merged, id == "TT24_161" & doy == 180) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_161_180)

aci_coefs[735, ] <- c(id = "TT24_161", spp = "Mai", plot = 6, subplot = NA,
                      doy = 180, t(coef(mai_TT24_161_180)),
                      leaf_length_cm = 19.6, stem_length_cm = 63.3)

# 5579
mai_5579_180 <- subset(li6800_merged, id == "5579" & doy == 180) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5579_180)

aci_coefs[736, ] <- c(id = "5579", spp = "Mai", plot = 6, subplot = 25,
                      doy = 180, t(coef(mai_5579_180)),
                      leaf_length_cm = 14.9, stem_length_cm = 41.1)

# 2608
mai_2608_180 <- subset(li6800_merged, id == "2608" & doy == 180) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_2608_180)

aci_coefs[737, ] <- c(id = "2608", spp = "Mai", plot = 6, subplot = 25,
                      doy = 180, t(coef(mai_2608_180)),
                      leaf_length_cm = 15.6, stem_length_cm = 49.5)

# 4237
mai_4237_180 <- subset(li6800_merged, id == "4237" & doy == 180) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_4237_180)

aci_coefs[738, ] <- c(id = "4237", spp = "Mai", plot = 6, subplot = 32,
                      doy = 180, t(coef(mai_4237_180)),
                      leaf_length_cm = 10.5, stem_length_cm = 49.4)

# TT24_160
mai_TT24_160_180 <- subset(li6800_merged, id == "TT24_160" & doy == 180) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_160_180)

aci_coefs[739, ] <- c(id = "TT24_160", spp = "Mai", plot = 6, subplot = 32,
                      doy = 180, t(coef(mai_TT24_160_180)),
                      leaf_length_cm = 10.4, stem_length_cm = 20.3)

# 5600
mai_5600_180 <- subset(li6800_merged, id == "5600" & doy == 180) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5600_180)

aci_coefs[740, ] <- c(id = "5600", spp = "Mai", plot = 6, subplot = 32,
                      doy = 180, t(coef(mai_5600_180)),
                      leaf_length_cm = 20.3, stem_length_cm = 73.5)

# 5178
mai_5178_180 <- subset(li6800_merged, id == "5178" & doy == 180) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5178_180)

aci_coefs[741, ] <- c(id = "5178", spp = "Mai", plot = 6, subplot = 32,
                      doy = 180, t(coef(mai_5178_180)),
                      leaf_length_cm = 17.0, stem_length_cm = 51.0)

# TT24_132
mai_TT24_132_180 <- subset(li6800_merged, id == "TT24_132" & doy == 180) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_132_180)

aci_coefs[742, ] <- c(id = "TT24_132", spp = "Mai", plot = 6, subplot = 2,
                      doy = 180, t(coef(mai_TT24_132_180)),
                      leaf_length_cm = 12.1, stem_length_cm = 25.3)

# TT24_205
mai_TT24_205_180 <- subset(li6800_merged, id == "TT24_205" & doy == 180) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_205_180)

aci_coefs[743, ] <- c(id = "TT24_205", spp = "Mai", plot = 6, subplot = 34,
                      doy = 180, t(coef(mai_TT24_205_180)),
                      leaf_length_cm = 17.4, stem_length_cm = 55.5)

# TT24_230
mai_TT24_230_180 <- subset(li6800_merged, id == "TT24_230" & doy == 180) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_230_180)

aci_coefs[744, ] <- c(id = "TT24_230", spp = "Mai", plot = 6, subplot = 29,
                      doy = 180, t(coef(mai_TT24_230_180)),
                      leaf_length_cm = 14.5, stem_length_cm = 45.1)

# TT24_206
mai_TT24_206_180 <- subset(li6800_merged, id == "TT24_206" & doy == 180) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_206_180)

aci_coefs[745, ] <- c(id = "TT24_206", spp = "Mai", plot = 6, subplot = 22,
                      doy = 180, t(coef(mai_TT24_206_180)),
                      leaf_length_cm = 13.2, stem_length_cm = NA)

# 3175
mai_3175_180 <- subset(li6800_merged, id == "3175" & doy == 180) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_3175_180)

aci_coefs[746, ] <- c(id = "3175", spp = "Mai", plot = 6, subplot = 22,
                      doy = 180, t(coef(mai_3175_180)),
                      leaf_length_cm = 14.6, stem_length_cm = 33.1)

# 6462
mai_6462_180 <- subset(li6800_merged, id == "6462" & doy == 180) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_6462_180)

aci_coefs[747, ] <- c(id = "6462", spp = "Mai", plot = 6, subplot = 36,
                      doy = 180, t(coef(mai_6462_180)),
                      leaf_length_cm = 16.3, stem_length_cm = 42.5)

# 6448
mai_6448_180 <- subset(li6800_merged, id == "6448" & doy == 180) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_6448_180)

aci_coefs[748, ] <- c(id = "6448", spp = "Mai", plot = 6, subplot = 36,
                      doy = 180, t(coef(mai_6448_180)),
                      leaf_length_cm = 16.6, stem_length_cm = 56.6)

# 2743
mai_2743_180 <- subset(li6800_merged, id == "2743" & doy == 180) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_2743_180)

aci_coefs[749, ] <- c(id = "2743", spp = "Mai", plot = 6, subplot = 36,
                      doy = 180, t(coef(mai_2743_180)),
                      leaf_length_cm = 10.8, stem_length_cm = 27.0)

#####################################################################
# 6/28/24: plot 5 (DOY = 180)
#####################################################################
# 2637
mai_2637_180 <- subset(li6800_merged, id == "2637" & doy == 180) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
plot(mai_2637_180)

aci_coefs[750, ] <- c(id = "2637", spp = "Mai", plot = 5, subplot = 36,
                      doy = 180, t(coef(mai_2637_180)),
                      leaf_length_cm = 15.5, stem_length_cm = 44.6)

#####################################################################
# 7/3/24: plot 5 (DOY = 185)
#####################################################################
unique(subset(li6800_merged, doy == 185)$id)

# 631
mai_631_185 <- subset(li6800_merged, id == "631" & doy == 185) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_631_185)

aci_coefs[751, ] <- c(id = "631", spp = "Mai", plot = 5, subplot = 3,
                      doy = 185, t(coef(mai_631_185)),
                      leaf_length_cm = 16.5, stem_length_cm = 64.5)

# 3960
mai_3960_185 <- subset(li6800_merged, id == "3960" & doy == 185) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_3960_185)

aci_coefs[752, ] <- c(id = "3960", spp = "Mai", plot = 5, subplot = 3,
                      doy = 185, t(coef(mai_3960_185)),
                      leaf_length_cm = 17.8, stem_length_cm = 55.5)

# 3993
mai_3993_185 <- subset(li6800_merged, id == "3993" & doy == 185) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_3993_185)

aci_coefs[753, ] <- c(id = "3993", spp = "Mai", plot = 5, subplot = 3,
                      doy = 185, t(coef(mai_3993_185)),
                      leaf_length_cm = 16.4, stem_length_cm = 46.4)

# 5657
mai_5657_185 <- subset(li6800_merged, id == "5657" & doy == 185) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5657_185)

aci_coefs[754, ] <- c(id = "5657", spp = "Mai", plot = 5, subplot = 23,
                      doy = 185, t(coef(mai_5657_185)),
                      leaf_length_cm = 16.5, stem_length_cm = 55.8)

# 4781
mai_4781_185 <- subset(li6800_merged, id == "4781" & doy == 185) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_4781_185)

aci_coefs[755, ] <- c(id = "4781", spp = "Mai", plot = 5, subplot = 23,
                      doy = 185, t(coef(mai_4781_185)),
                      leaf_length_cm = 16.7, stem_length_cm = 62.8)

# 2803
mai_2803_185 <- subset(li6800_merged, id == "2803" & doy == 185) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_2803_185)

aci_coefs[756, ] <- c(id = "2803", spp = "Mai", plot = 5, subplot = 18,
                      doy = 185, t(coef(mai_2803_185)),
                      leaf_length_cm = 16.7, stem_length_cm = 48.5)



#####################################################################
# 7/5/24: plot 3 (DOY = 187)
#####################################################################
unique(subset(li6800_merged, doy == 187)$id)

# 5184
mai_5184_187 <- subset(li6800_merged, id == "5184" & doy == 187) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5184_187)

aci_coefs[757, ] <- c(id = "5184", spp = "Mai", plot = 3, subplot = 13,
                      doy = 187, t(coef(mai_5184_187)),
                      leaf_length_cm = 15.8, stem_length_cm = 41.4)

# TT24_110
mai_TT24_110_187 <- subset(li6800_merged, id == "TT24_110" & doy == 187) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_110_187)

aci_coefs[758, ] <- c(id = "TT24_110", spp = "Mai", plot = 3, subplot = NA,
                      doy = 187, t(coef(mai_TT24_110_187)),
                      leaf_length_cm = 17.1, stem_length_cm = 54.4)

# 5105
mai_5105_187 <- subset(li6800_merged, id == "5105" & doy == 187) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5105_187)

aci_coefs[759, ] <- c(id = "5105", spp = "Mai", plot = 3, subplot = 8,
                      doy = 187, t(coef(mai_5105_187)),
                      leaf_length_cm = 14.5, stem_length_cm = 39.6)

# TT24_111
mai_TT24_111_187 <- subset(li6800_merged, id == "TT24_111" & doy == 187) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_111_187)

aci_coefs[760, ] <- c(id = "TT24_111", spp = "Mai", plot = 3, subplot = NA,
                      doy = 187, t(coef(mai_TT24_111_187)),
                      leaf_length_cm = 16.2, stem_length_cm = 59.6)

# TT24_112
mai_TT24_112_187 <- subset(li6800_merged, id == "TT24_112" & doy == 187) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_112_187)

aci_coefs[761, ] <- c(id = "TT24_112", spp = "Mai", plot = 3, subplot = 2,
                      doy = 187, t(coef(mai_TT24_112_187)),
                      leaf_length_cm = 16.1, stem_length_cm = 60.9)

# 4250
mai_4250_187 <- subset(li6800_merged, id == "4250" & doy == 187) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_4250_187)

aci_coefs[762, ] <- c(id = "4250", spp = "Mai", plot = 3, subplot = 2,
                      doy = 187, t(coef(mai_4250_187)),
                      leaf_length_cm = 13.1, stem_length_cm = 33.6)

# TT24_212
mai_TT24_212_187 <- subset(li6800_merged, id == "TT24_212" & doy == 187) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_212_187)

aci_coefs[763, ] <- c(id = "TT24_212", spp = "Mai", plot = 3, subplot = 4,
                      doy = 187, t(coef(mai_TT24_212_187)),
                      leaf_length_cm = 16.6, stem_length_cm = 48.3)

# 129
mai_129_187 <- subset(li6800_merged, id == "129" & doy == 187) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_129_187)

aci_coefs[764, ] <- c(id = "129", spp = "Mai", plot = 3, subplot = 12,
                      doy = 187, t(coef(mai_129_187)),
                      leaf_length_cm = 8.2, stem_length_cm = 16.6)

# 3643
mai_3643_187 <- subset(li6800_merged, id == "3643" & doy == 187) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_3643_187)

aci_coefs[765, ] <- c(id = "3643", spp = "Mai", plot = 3, subplot = 12,
                      doy = 187, t(coef(mai_3643_187)),
                      leaf_length_cm = 8.5, stem_length_cm = 17.0)

#####################################################################
# 7/5/24: plot 6 (DOY = 187)
#####################################################################
unique(subset(li6800_merged, doy == 187)$id)

# 5567
mai_5567_187 <- subset(li6800_merged, id == "5567" & doy == 187) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5567_187)

aci_coefs[766, ] <- c(id = "5567", spp = "Mai", plot = 6, subplot = 22,
                      doy = 187, t(coef(mai_5567_187)),
                      leaf_length_cm = 19.0, stem_length_cm = 57.3)

# 6463
mai_6463_187 <- subset(li6800_merged, id == "6463" & doy == 187) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_6463_187)

aci_coefs[767, ] <- c(id = "6463", spp = "Mai", plot = 6, subplot = NA,
                      doy = 187, t(coef(mai_6463_187)),
                      leaf_length_cm = 12.9, stem_length_cm = 32.9)

# 3438
mai_3438_187 <- subset(li6800_merged, id == "3438" & doy == 187 & Ci < 600) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_3438_187)

aci_coefs[768, ] <- c(id = "3438", spp = "Mai", plot = 6, subplot = 11,
                      doy = 187, t(coef(mai_3438_187)),
                      leaf_length_cm = 20.0, stem_length_cm = 62.1)

# 4216
mai_4216_187 <- subset(li6800_merged, id == "4216" & doy == 187) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_4216_187)

aci_coefs[769, ] <- c(id = "4216", spp = "Mai", plot = 6, subplot = 11,
                      doy = 187, t(coef(mai_4216_187)),
                      leaf_length_cm = 17.9, stem_length_cm = 59.4)

# 5569
mai_5569_187 <- subset(li6800_merged, id == "5569" & doy == 187) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5569_187)

aci_coefs[770, ] <- c(id = "5569", spp = "Mai", plot = 6, subplot = 11,
                      doy = 187, t(coef(mai_5569_187)),
                      leaf_length_cm = 17.5, stem_length_cm = 49.9)

# 5025
mai_5025_187 <- subset(li6800_merged, id == "5025" & doy == 187) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5025_187)

aci_coefs[771, ] <- c(id = "5025", spp = "Mai", plot = 6, subplot = 11,
                      doy = 187, t(coef(mai_5025_187)),
                      leaf_length_cm = 19.4, stem_length_cm = 66.5)

# TT24_234
mai_TT24_234_187 <- subset(li6800_merged, id == "TT24_234" & doy == 187) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_234_187)

aci_coefs[772, ] <- c(id = "TT24_234", spp = "Mai", plot = 6, subplot = 11,
                      doy = 187, t(coef(mai_TT24_234_187)),
                      leaf_length_cm = 17.2, stem_length_cm = 56.0)

# TT24_231
mai_TT24_231_187 <- subset(li6800_merged, id == "TT24_231" & doy == 187) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_231_187)

aci_coefs[773, ] <- c(id = "TT24_231", spp = "Mai", plot = 6, subplot = 6,
                      doy = 187, t(coef(mai_TT24_231_187)),
                      leaf_length_cm = 14.0, stem_length_cm = 40.1)

# TT24_232
mai_TT24_232_187 <- subset(li6800_merged, id == "TT24_232" & doy == 187) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_232_187)

aci_coefs[774, ] <- c(id = "TT24_232", spp = "Mai", plot = 6, subplot = 12,
                      doy = 187, t(coef(mai_TT24_232_187)),
                      leaf_length_cm = 15.5, stem_length_cm = 45.5)

#####################################################################
# 7/6/24: plot 6 (DOY = 188)
#####################################################################
unique(subset(li6800_merged, doy == 188)$id)

# TT24_150
mai_TT24_150_188 <- subset(li6800_merged, id == "TT24_150" & doy == 188) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_150_188)

aci_coefs[775, ] <- c(id = "TT24_150", spp = "Mai", plot = 6, subplot = 19,
                      doy = 188, t(coef(mai_TT24_150_188)),
                      leaf_length_cm = 18.0, stem_length_cm = 62.1)

# 6483
mai_6483_188 <- subset(li6800_merged, id == "6483" & doy == 188) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_6483_188)

aci_coefs[776, ] <- c(id = "6483", spp = "Mai", plot = 6, subplot = 19,
                      doy = 188, t(coef(mai_6483_188)),
                      leaf_length_cm = 16.1, stem_length_cm = 49.4)

# 1942
mai_1942_188 <- subset(li6800_merged, id == "1942" & doy == 188) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_1942_188)

aci_coefs[777, ] <- c(id = "1942", spp = "Mai", plot = 6, subplot = 19,
                      doy = 188, t(coef(mai_1942_188)),
                      leaf_length_cm = 15.4, stem_length_cm = 50.3)

# TT24_135
mai_TT24_135_188 <- subset(li6800_merged, id == "TT24_135" & doy == 188) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_135_188)

aci_coefs[778, ] <- c(id = "TT24_135", spp = "Mai", plot = 6, subplot = 20,
                      doy = 188, t(coef(mai_TT24_135_188)),
                      leaf_length_cm = 16.4, stem_length_cm = 56.7)

# 2639
mai_2639_188 <- subset(li6800_merged, id == "2639" & doy == 188) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_2639_188)

aci_coefs[779, ] <- c(id = "2639", spp = "Mai", plot = 6, subplot = 21,
                      doy = 188, t(coef(mai_2639_188)),
                      leaf_length_cm = 14.6, stem_length_cm = 33.1)

# 2692
mai_2692_188 <- subset(li6800_merged, id == "2692" & doy == 188) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_2692_188)

aci_coefs[780, ] <- c(id = "2692", spp = "Mai", plot = 6, subplot = 21,
                      doy = 188, t(coef(mai_2692_188)),
                      leaf_length_cm = 17.7, stem_length_cm = 58.5)

# 2799
mai_2799_188 <- subset(li6800_merged, id == "2799" & doy == 188) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_2799_188)

aci_coefs[781, ] <- c(id = "2799", spp = "Mai", plot = 6, subplot = 14,
                      doy = 188, t(coef(mai_2799_188)),
                      leaf_length_cm = 18.5, stem_length_cm = 57.1)

# 5607
mai_5607_188 <- subset(li6800_merged, id == "5607" & doy == 188) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5607_188)

aci_coefs[782, ] <- c(id = "5607", spp = "Mai", plot = 6, subplot = 9,
                      doy = 188, t(coef(mai_5607_188)),
                      leaf_length_cm = 13.6, stem_length_cm = 35.4)

# 5664
mai_5664_188 <- subset(li6800_merged, id == "5664" & doy == 188) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5664_188)

aci_coefs[783, ] <- c(id = "5664", spp = "Mai", plot = 6, subplot = 9,
                      doy = 188, t(coef(mai_5664_188)),
                      leaf_length_cm = 16.1, stem_length_cm = 47.9)

# 5596
mai_5596_188 <- subset(li6800_merged, id == "5596" & doy == 188) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5596_188)

aci_coefs[784, ] <- c(id = "5596", spp = "Mai", plot = 6, subplot = 8,
                      doy = 188, t(coef(mai_5596_188)),
                      leaf_length_cm = 20.9, stem_length_cm = 69.6)

# TT24_130
mai_TT24_130_188 <- subset(li6800_merged, id == "TT24_130" & doy == 188) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_130_188)

aci_coefs[785, ] <- c(id = "TT24_130", spp = "Mai", plot = 6, subplot = 8,
                      doy = 188, t(coef(mai_TT24_130_188)),
                      leaf_length_cm = 17.1, stem_length_cm = 50.3)

# 1146
mai_1146_188 <- subset(li6800_merged, id == "1146" & doy == 188) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_1146_188)

aci_coefs[786, ] <- c(id = "1146", spp = "Mai", plot = 6, subplot = 8,
                      doy = 188, t(coef(mai_1146_188)),
                      leaf_length_cm = 17.4, stem_length_cm = 60.5)

# 5009
mai_5009_188 <- subset(li6800_merged, id == "5009" & doy == 188) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5009_188)

aci_coefs[787, ] <- c(id = "5009", spp = "Mai", plot = 6, subplot = 8,
                      doy = 188, t(coef(mai_5009_188)),
                      leaf_length_cm = 16.1, stem_length_cm = 50.1)

# 1495
mai_1495_188 <- subset(li6800_merged, id == "1495" & doy == 188) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_1495_188)

aci_coefs[788, ] <- c(id = "1495", spp = "Mai", plot = 6, subplot = 8,
                      doy = 188, t(coef(mai_1495_188)),
                      leaf_length_cm = 17.5, stem_length_cm = 59.3)

# 4722
mai_4722_188 <- subset(li6800_merged, id == "4722" & doy == 188) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_4722_188)

aci_coefs[789, ] <- c(id = "4722", spp = "Mai", plot = 6, subplot = 8,
                      doy = 188, t(coef(mai_4722_188)),
                      leaf_length_cm = 18.5, stem_length_cm = 62.1)

# 5122
mai_5122_188 <- subset(li6800_merged, id == "5122" & doy == 188) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5122_188)

aci_coefs[790, ] <- c(id = "5122", spp = "Mai", plot = 6, subplot = 2,
                      doy = 188, t(coef(mai_5122_188)),
                      leaf_length_cm = 17.2, stem_length_cm = 43.0)

# 3468
mai_3468_188 <- subset(li6800_merged, id == "3468" & doy == 188) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_3468_188)

aci_coefs[791, ] <- c(id = "3468", spp = "Mai", plot = 6, subplot = 9,
                      doy = 188, t(coef(mai_3468_188)),
                      leaf_length_cm = 20.0, stem_length_cm = 67.8)

# TT24_131
mai_TT24_131_188 <- subset(li6800_merged, id == "TT24_131" & doy == 188 & (A < 4 | A > 10)) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_131_188)

aci_coefs[792, ] <- c(id = "TT24_131", spp = "Mai", plot = 6, subplot = 9,
                      doy = 188, t(coef(mai_TT24_131_188)),
                      leaf_length_cm = 19.6, stem_length_cm = 58.0)

#####################################################################
# 7/11/24: plot 3 (DOY = 193)
#####################################################################
unique(subset(li6800_merged, doy == 193)$id)

# 511
mai_511_193 <- subset(li6800_merged, id == "511" & doy == 193) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_511_193)

aci_coefs[793, ] <- c(id = "511", spp = "Mai", plot = 3, subplot = 30,
                      doy = 193, t(coef(mai_511_193)),
                      leaf_length_cm = 10.4, stem_length_cm = 24.6)

# TT24_211
mai_TT24_211_193 <- subset(li6800_merged, id == "TT24_211" & doy == 193) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_211_193)

aci_coefs[794, ] <- c(id = "TT24_211", spp = "Mai", plot = 3, subplot = 18,
                      doy = 193, t(coef(mai_TT24_211_193)),
                      leaf_length_cm = 9.6, stem_length_cm = 15.9)

# 1251
mai_1251_193 <- subset(li6800_merged, id == "1251" & doy == 193) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_1251_193)

aci_coefs[795, ] <- c(id = "1251", spp = "Mai", plot = 3, subplot = 33,
                      doy = 193, t(coef(mai_1251_193)),
                      leaf_length_cm = 15.2, stem_length_cm = 52.1)

# TT24_201
mai_TT24_201_193 <- subset(li6800_merged, id == "TT24_201" & doy == 193 & (A < 1 | A > 2.5)) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_201_193)

aci_coefs[796, ] <- c(id = "TT24_201", spp = "Mai", plot = 3, subplot = 35,
                      doy = 193, t(coef(mai_TT24_201_193)),
                      leaf_length_cm = 9.5, stem_length_cm = 22.9)

# TT24_204
mai_TT24_204_193 <- subset(li6800_merged, id == "TT24_204" & doy == 193) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_204_193)

aci_coefs[797, ] <- c(id = "TT24_204", spp = "Mai", plot = 3, subplot = 35,
                      doy = 193, t(coef(mai_TT24_204_193)),
                      leaf_length_cm = 13.5, stem_length_cm = 39.6)

#####################################################################
# 7/11/24: plot 6 (DOY = 193)
#####################################################################

# TT24_230
mai_TT24_230_193 <- subset(li6800_merged, id == "TT24_230" & doy == 193) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_230_193)

aci_coefs[798, ] <- c(id = "TT24_230", spp = "Mai", plot = 6, subplot = 29,
                      doy = 193, t(coef(mai_TT24_230_193)),
                      leaf_length_cm = 15.4, stem_length_cm = 42.6)

# TT24_206
mai_TT24_206_193 <- subset(li6800_merged, id == "TT24_206" & doy == 193) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_206_193)

aci_coefs[799, ] <- c(id = "TT24_206", spp = "Mai", plot = 6, subplot = 22,
                      doy = 193, t(coef(mai_TT24_206_193)),
                      leaf_length_cm = 13.4, stem_length_cm = NA)

# 3175
mai_3175_193 <- subset(li6800_merged, id == "3175" & doy == 193) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_3175_193)

aci_coefs[800, ] <- c(id = "3175", spp = "Mai", plot = 6, subplot = 22,
                      doy = 193, t(coef(mai_3175_193)),
                      leaf_length_cm = 16.4, stem_length_cm = 43.1)

# 6462
mai_6462_193 <- subset(li6800_merged, id == "6462" & doy == 193 & A > 7) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
plot(mai_6462_193)

aci_coefs[801, ] <- c(id = "6462", spp = "Mai", plot = 6, subplot = 36,
                      doy = 193, t(coef(mai_6462_193)),
                      leaf_length_cm = 15.7, stem_length_cm = 43.4)

# 6448
mai_6448_193 <- subset(li6800_merged, id == "6448" & doy == 193) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_6448_193)

aci_coefs[802, ] <- c(id = "6448", spp = "Mai", plot = 6, subplot = 36,
                      doy = 193, t(coef(mai_6448_193)),
                      leaf_length_cm = 16.6, stem_length_cm = 57.0)

# 2743
mai_2743_193 <- subset(li6800_merged, id == "2743" & doy == 193) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_2743_193)

aci_coefs[803, ] <- c(id = "2743", spp = "Mai", plot = 6, subplot = 36,
                      doy = 193, t(coef(mai_2743_193)),
                      leaf_length_cm = 10.5, stem_length_cm = 27.0)

# 5060
mai_5060_193 <- subset(li6800_merged, id == "5060" & doy == 193 & A > 2) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5060_193)

aci_coefs[904, ] <- c(id = "5060", spp = "Mai", plot = 6, subplot = 27,
                      doy = 193, t(coef(mai_5060_193)),
                      leaf_length_cm = 12.8, stem_length_cm = 38.2)

#####################################################################
# 7/12/24: plot 3 (DOY = 194)
#####################################################################
unique(subset(li6800_merged, doy == 194)$id)

# TT24_102
mai_TT24_102_194 <- subset(li6800_merged, id == "TT24_102" & doy == 194) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_102_194)

aci_coefs[804, ] <- c(id = "TT24_102", spp = "Mai", plot = 3, subplot = 32,
                      doy = 194, t(coef(mai_TT24_102_194)),
                      leaf_length_cm = NA, stem_length_cm = NA)

# 5006
mai_5006_194 <- subset(li6800_merged, id == "5006" & doy == 194 & (A < 0 | A > 2.5)) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
plot(mai_5006_194)

aci_coefs[805, ] <- c(id = "5006", spp = "Mai", plot = 3, subplot = 24,
                      doy = 194, t(coef(mai_5006_194)),
                      leaf_length_cm = 12.8, stem_length_cm = 38.2)

#####################################################################
# 7/12/24: plot 6 (DOY = 194)
#####################################################################
unique(subset(li6800_merged, doy == 194)$id)

# 6495
mai_6495_194 <- subset(li6800_merged, id == "6495" & doy == 194) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_6495_194)

aci_coefs[806, ] <- c(id = "6495", spp = "Mai", plot = 6, subplot = 25,
                   doy = 194, t(coef(mai_6495_194)),
                   leaf_length_cm = 19.5, stem_length_cm = 61.4)

# 5579
mai_5579_194 <- subset(li6800_merged, id == "5579" & doy == 194 & (A < 1 | A > 6)) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5579_194)

aci_coefs[807, ] <- c(id = "5579", spp = "Mai", plot = 6, subplot = 25,
                   doy = 194, t(coef(mai_5579_194)),
                   leaf_length_cm = 20.1, stem_length_cm = 65.4)

# 2608
mai_2608_194 <- subset(li6800_merged, id == "2608" & doy == 194 & (A < 1 | A > 4)) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_2608_194)

aci_coefs[808, ] <- c(id = "2608", spp = "Mai", plot = 6, subplot = 25,
                   doy = 194, t(coef(mai_2608_194)),
                   leaf_length_cm = 15.9, stem_length_cm = 49.4)

# TT24_160
mai_TT24_160_194 <- subset(li6800_merged, id == "TT24_160" & doy == 194 & (A < 2 | A > 5.75)) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_160_194)

aci_coefs[809, ] <- c(id = "TT24_160", spp = "Mai", plot = 6, subplot = 32,
                   doy = 194, t(coef(mai_TT24_160_194)),
                   leaf_length_cm = 10.2, stem_length_cm = 20.5)

# TT24_132
mai_TT24_132_194 <- subset(li6800_merged, id == "TT24_132" & doy == 194 & Ci < 600) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_132_194)

aci_coefs[810, ] <- c(id = "TT24_132", spp = "Mai", plot = 6, subplot = NA,
                   doy = 194, t(coef(mai_TT24_132_194)),
                   leaf_length_cm = 12.1, stem_length_cm = 25.6)

# 5178
mai_5178_194 <- subset(li6800_merged, id == "5178" & doy == 194 & Ci < 600) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5178_194)

aci_coefs[811, ] <- c(id = "5178", spp = "Mai", plot = 6, subplot = 32,
                   doy = 194, t(coef(mai_5178_194)),
                   leaf_length_cm = 17.2, stem_length_cm = 59.5)

# 5600
mai_5600_194 <- subset(li6800_merged, id == "5600" & doy == 194) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5600_194)

aci_coefs[812, ] <- c(id = "5600", spp = "Mai", plot = 6, subplot = 32,
                   doy = 194, t(coef(mai_5600_194)),
                   leaf_length_cm = 21.2, stem_length_cm = 75.4)

# 4237
mai_4237_194 <- subset(li6800_merged, id == "4237" & doy == 194) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_4237_194)

aci_coefs[813, ] <- c(id = "4237", spp = "Mai", plot = 6, subplot = 32,
                   doy = 194, t(coef(mai_4237_194)),
                   leaf_length_cm = 10.4, stem_length_cm = 48.3)

#####################################################################
# 7/18/24: plot 6 (DOY = 200)
#####################################################################
unique(subset(li6800_merged, doy == 200)$id)

# TT24_150
mai_TT24_150_200 <- subset(li6800_merged, id == "TT24_150" & doy == 200) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_150_200)

aci_coefs[814, ] <- c(id = "TT24_150", spp = "Mai", plot = 6, subplot = 19,
                      doy = 200, t(coef(mai_TT24_150_200)),
                      leaf_length_cm = 18.2, stem_length_cm = 62.6)

# 6483
mai_6483_200 <- subset(li6800_merged, id == "6483" & doy == 200) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_6483_200)

aci_coefs[815, ] <- c(id = "6483", spp = "Mai", plot = 6, subplot = 19,
                   doy = 200, t(coef(mai_6483_200)),
                   leaf_length_cm = 15.6, stem_length_cm = 51.5)

# 1941
mai_1941_200 <- subset(li6800_merged, id == "1941" & doy == 200) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_1941_200)

aci_coefs[816, ] <- c(id = "1941", spp = "Mai", plot = 6, subplot = 19,
                   doy = 200, t(coef(mai_1941_200)),
                   leaf_length_cm = 15.6, stem_length_cm = 49.1)

# TT24_135
mai_TT24_135_200 <- subset(li6800_merged, id == "TT24_135" & doy == 200) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_135_200)

aci_coefs[817, ] <- c(id = "TT24_135", spp = "Mai", plot = 6, subplot = 20,
                   doy = 200, t(coef(mai_TT24_135_200)),
                   leaf_length_cm = 16.1, stem_length_cm = 60.1)

# 2639
mai_2639_200 <- subset(li6800_merged, id == "2639" & doy == 200) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_2639_200)

aci_coefs[818, ] <- c(id = "2639", spp = "Mai", plot = 6, subplot = 21,
                   doy = 200, t(coef(mai_2639_200)),
                   leaf_length_cm = 14.6, stem_length_cm = 31.2)

# 2692
mai_2692_200 <- subset(li6800_merged, id == "2692" & doy == 200) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_2692_200)

aci_coefs[819, ] <- c(id = "2692", spp = "Mai", plot = 6, subplot = 21,
                   doy = 200, t(coef(mai_2692_200)),
                   leaf_length_cm = 17.7, stem_length_cm = 60.7)

# 2799
mai_2799_200 <- subset(li6800_merged, id == "2799" & doy == 200) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_2799_200)

aci_coefs[820, ] <- c(id = "2799", spp = "Mai", plot = 6, subplot = 14,
                   doy = 200, t(coef(mai_2799_200)),
                   leaf_length_cm = 18.7, stem_length_cm = 58.9)

# TT24_130
mai_TT24_130_200 <- subset(li6800_merged, id == "TT24_130" & doy == 200) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_130_200)

aci_coefs[821, ] <- c(id = "TT24_130", spp = "Mai", plot = 6, subplot = 8,
                   doy = 200, t(coef(mai_TT24_130_200)),
                   leaf_length_cm = 16.7, stem_length_cm = 47.3)

# 5596
mai_5596_200 <- subset(li6800_merged, id == "5596" & doy == 200) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5596_200)

aci_coefs[822, ] <- c(id = "5596", spp = "Mai", plot = 6, subplot = 8,
                   doy = 200, t(coef(mai_5596_200)),
                   leaf_length_cm = 9.9, stem_length_cm = 15.2)

# 5122
mai_5122_200 <- subset(li6800_merged, id == "5122" & doy == 200) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5122_200)

aci_coefs[823, ] <- c(id = "5122", spp = "Mai", plot = 6, subplot = 2,
                   doy = 200, t(coef(mai_5122_200)),
                   leaf_length_cm = 16.2, stem_length_cm = 43.8)

# 4722
mai_4722_200 <- subset(li6800_merged, id == "4722" & doy == 200) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_4722_200)

aci_coefs[824, ] <- c(id = "4722", spp = "Mai", plot = 6, subplot = 8,
                   doy = 200, t(coef(mai_4722_200)),
                   leaf_length_cm = 18.1, stem_length_cm = 62.5)

# 1495
mai_1495_200 <- subset(li6800_merged, id == "1495" & doy == 200) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_1495_200)

aci_coefs[825, ] <- c(id = "1495", spp = "Mai", plot = 6, subplot = 8,
                   doy = 200, t(coef(mai_1495_200)),
                   leaf_length_cm = 16.6, stem_length_cm = 57.2)

# 5009
mai_5009_200 <- subset(li6800_merged, id == "5009" & doy == 200 & A > 4) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5009_200)

aci_coefs[826, ] <- c(id = "5009", spp = "Mai", plot = 6, subplot = 8,
                   doy = 200, t(coef(mai_5009_200)),
                   leaf_length_cm = 15.5, stem_length_cm = 50.4)

# 1146
mai_1146_200 <- subset(li6800_merged, id == "1146" & doy == 200) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_1146_200)

aci_coefs[827, ] <- c(id = "1146", spp = "Mai", plot = 6, subplot = 8,
                   doy = 200, t(coef(mai_1146_200)),
                   leaf_length_cm = 17.2, stem_length_cm = 56.3)

# 3468
mai_3468_200 <- subset(li6800_merged, id == "3468" & doy == 200) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_3468_200)

aci_coefs[828, ] <- c(id = "3468", spp = "Mai", plot = 6, subplot = 9,
                   doy = 200, t(coef(mai_3468_200)),
                   leaf_length_cm = 18.9, stem_length_cm = 66.0)

# 5567
mai_5567_200 <- subset(li6800_merged, id == "5567" & doy == 200) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5567_200)

aci_coefs[829, ] <- c(id = "5567", spp = "Mai", plot = 6, subplot = 22,
                   doy = 200, t(coef(mai_5567_200)),
                   leaf_length_cm = 19.2, stem_length_cm = 53.8)

# 6463
mai_6463_200 <- subset(li6800_merged, id == "6463" & doy == 200) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_6463_200)

aci_coefs[830, ] <- c(id = "6463", spp = "Mai", plot = 6, subplot = NA,
                   doy = 200, t(coef(mai_6463_200)),
                   leaf_length_cm = 13.0, stem_length_cm = 27.1)

# 4216
mai_4216_200 <- subset(li6800_merged, id == "4216" & doy == 200) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_4216_200)

aci_coefs[831, ] <- c(id = "4216", spp = "Mai", plot = 6, subplot = 11,
                   doy = 200, t(coef(mai_4216_200)),
                   leaf_length_cm = 17.6, stem_length_cm = 60.1)

# 3438
mai_3438_200 <- subset(li6800_merged, id == "3438" & doy == 200 & (A < 2 | A > 4.5)) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_3438_200)

aci_coefs[832, ] <- c(id = "3438", spp = "Mai", plot = 6, subplot = 11,
                   doy = 200, t(coef(mai_3438_200)),
                   leaf_length_cm = 19.5, stem_length_cm = 62.6)

# 5569
mai_5569_200 <- subset(li6800_merged, id == "5569" & doy == 200) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5569_200)

aci_coefs[833, ] <- c(id = "5569", spp = "Mai", plot = 6, subplot = 11,
                   doy = 200, t(coef(mai_5569_200)),
                   leaf_length_cm = 17.5, stem_length_cm = 51.2)

# 5025
mai_5025_200 <- subset(li6800_merged, id == "5025" & doy == 200) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5025_200)

aci_coefs[834, ] <- c(id = "5025", spp = "Mai", plot = 6, subplot = 11,
                   doy = 200, t(coef(mai_5025_200)),
                   leaf_length_cm = 19.4, stem_length_cm = 65.1)

# TT24_234
mai_TT24_234_200 <- subset(li6800_merged, id == "TT24_234" & doy == 200) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_234_200)

aci_coefs[835, ] <- c(id = "TT24_234", spp = "Mai", plot = 6, subplot = 11,
                   doy = 200, t(coef(mai_TT24_234_200)),
                   leaf_length_cm = 17.4, stem_length_cm = 55.2)

# TT24_231 
mai_TT24_231_200 <- subset(li6800_merged, id == "TT24_231" & doy == 200) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_231_200)

aci_coefs[836, ] <- c(id = "TT24_231", spp = "Mai", plot = 6, subplot = 12,
                   doy = 200, t(coef(mai_TT24_231_200)),
                   leaf_length_cm = 13.9, stem_length_cm = 41.1)

# TT24_232
mai_TT24_232_200 <- subset(li6800_merged, id == "TT24_232" & doy == 200) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_232_200)

aci_coefs[837, ] <- c(id = "TT24_232", spp = "Mai", plot = 6, subplot = 6,
                   doy = 200, t(coef(mai_TT24_232_200)),
                   leaf_length_cm = 15.3, stem_length_cm = 46.7)

# 5664
mai_5664_200 <- subset(li6800_merged, id == "5664" & doy == 200) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5664_200)

aci_coefs[838, ] <- c(id = "5664", spp = "Mai", plot = 6, subplot = 9,
                   doy = 200, t(coef(mai_5664_200)),
                   leaf_length_cm = 16.3, stem_length_cm = 52.0)

# 5607
mai_5607_200 <- subset(li6800_merged, id == "5607" & doy == 200) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5607_200)

aci_coefs[839, ] <- c(id = "5607", spp = "Mai", plot = 6, subplot = 9,
                   doy = 200, t(coef(mai_5607_200)),
                   leaf_length_cm = 14.4, stem_length_cm = 37.6)

# TT24_131
mai_TT24_131_200 <- subset(li6800_merged, id == "TT24_131" & doy == 200) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_131_200)

aci_coefs[840, ] <- c(id = "TT24_131", spp = "Mai", plot = 6, subplot = 9,
                   doy = 200, t(coef(mai_TT24_131_200)),
                   leaf_length_cm = 19.5, stem_length_cm = 60.4)

#####################################################################
# 7/19/24: plot 3 (DOY = 201)
#####################################################################
unique(subset(li6800_merged, doy == 201)$id)

# TT24_111
mai_TT24_111_201 <- subset(li6800_merged, id == "TT24_111" & doy == 201) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_111_201)

aci_coefs[841, ] <- c(id = "TT24_111", spp = "Mai", plot = 3, subplot = NA ,
                      doy = 201, t(coef(mai_TT24_111_201)),
                      leaf_length_cm = 16.5, stem_length_cm = 60.1)

# 5105
mai_5105_201 <- subset(li6800_merged, id == "5105" & doy == 201) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5105_201)

aci_coefs[842, ] <- c(id = "5105", spp = "Mai", plot = 3, subplot = 8,
                   doy = 201, t(coef(mai_5105_201)),
                   leaf_length_cm = 14.7, stem_length_cm = 40.6)

# 5184
mai_5184_201 <- subset(li6800_merged, id == "5184" & doy == 201) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5184_201)

aci_coefs[843, ] <- c(id = "5184", spp = "Mai", plot = 3, subplot = 13,
                   doy = 201, t(coef(mai_5184_201)),
                   leaf_length_cm = 15.7, stem_length_cm = 42.3)

# TT24_112
mai_TT24_112_201 <- subset(li6800_merged, id == "TT24_112" & doy == 201 & (A < 1 | A > 3) & Ci < 470) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
plot(mai_TT24_112_201)

aci_coefs[844, ] <- c(id = "TT24_112", spp = "Mai", plot = 3, subplot = 2,
                   doy = 201, t(coef(mai_TT24_112_201)),
                   leaf_length_cm = 16.2, stem_length_cm = 56.1)

# 4250
mai_4250_201 <- subset(li6800_merged, id == "4250" & doy == 201 & Ci < 550 & (A < 1.75 | A > 4.5)) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_4250_201)

aci_coefs[845, ] <- c(id = "4250", spp = "Mai", plot = 3, subplot = 2,
                   doy = 201, t(coef(mai_4250_201)),
                   leaf_length_cm = 12.6, stem_length_cm = 28.3)

# 9412
mai_9412_201 <- subset(li6800_merged, id == "9412" & doy == 201) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_9412_201)

aci_coefs[846, ] <- c(id = "9412", spp = "Mai", plot = 3, subplot = 3,
                   doy = 201, t(coef(mai_9412_201)),
                   leaf_length_cm = 15.6, stem_length_cm = 45.9)

# TT24_212
mai_TT24_212_201 <- subset(li6800_merged, id == "TT24_212" & doy == 201) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
plot(mai_TT24_212_201)

aci_coefs[847, ] <- c(id = "TT24_212", spp = "Mai", plot = 3, subplot = NA,
                   doy = 201, t(coef(mai_TT24_212_201)),
                   leaf_length_cm = NA, stem_length_cm = NA)

# 3643
mai_3643_201 <- subset(li6800_merged, id == "3643" & doy == 201) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
plot(mai_3643_201)

aci_coefs[848, ] <- c(id = "3643", spp = "Mai", plot = 3, subplot = 12,
                   doy = 201, t(coef(mai_3643_201)),
                   leaf_length_cm = 8.5, stem_length_cm = 19.3)

#####################################################################
# 7/18/24: plot 5 (DOY = 201)
#####################################################################

# 631
mai_631_201 <- subset(li6800_merged, id == "631" & doy == 201) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_631_201)

aci_coefs[849, ] <- c(id = "631", spp = "Mai", plot = 5, subplot = 3,
                   doy = 201, t(coef(mai_631_201)),
                   leaf_length_cm = 17.1, stem_length_cm = 65.4)

# 3960
mai_3960_201 <- subset(li6800_merged, id == "3960" & doy == 201) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_3960_201)

aci_coefs[850, ] <- c(id = "3960", spp = "Mai", plot = 5, subplot = 3,
                   doy = 201, t(coef(mai_3960_201)),
                   leaf_length_cm = 18.1, stem_length_cm = 61.6)

# 3993
mai_3993_201 <- subset(li6800_merged, id == "3993" & doy == 201) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_3993_201)

aci_coefs[851, ] <- c(id = "3993", spp = "Mai", plot = 5, subplot = 3,
                   doy = 201, t(coef(mai_3993_201)),
                   leaf_length_cm = 16.6, stem_length_cm = 47.9)

# 5657
mai_5657_201 <- subset(li6800_merged, id == "5657" & doy == 201) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5657_201)

aci_coefs[852, ] <- c(id = "5657", spp = "Mai", plot = 5, subplot = 23,
                   doy = 201, t(coef(mai_5657_201)),
                   leaf_length_cm = 17.0, stem_length_cm = 55.5)

# 2803
mai_2803_201 <- subset(li6800_merged, id == "2803" & doy == 201) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_2803_201)

aci_coefs[853, ] <- c(id = "2803", spp = "Mai", plot = 5, subplot = 18,
                   doy = 201, t(coef(mai_2803_201)),
                   leaf_length_cm = 16.7, stem_length_cm = 52.1)

#####################################################################
# 8/20/24: plot 3 (DOY = 233)
#####################################################################
unique(subset(li6800_merged, doy == 233)$id)

# TT24_101
mai_TT24_101_233 <- subset(li6800_merged, id == "TT24_101" & doy == 233) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_101_233)

aci_coefs[854, ] <- c(id = "TT24_101", spp = "Mai", plot = 3, subplot = 32,
                      doy = 233, t(coef(mai_TT24_101_233)),
                      leaf_length_cm = 13.6, stem_length_cm = 36.6)

# 1251
mai_1251_233 <- subset(li6800_merged, id == "1251" & doy == 233) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_1251_233)

aci_coefs[855, ] <- c(id = "1251", spp = "Mai", plot = 3, subplot = 33,
                   doy = 233, t(coef(mai_1251_233)),
                   leaf_length_cm = NA, stem_length_cm = NA)

# TT24_204
mai_TT24_204_233 <- subset(li6800_merged, id == "TT24_204" & doy == 233) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_204_233)

aci_coefs[856, ] <- c(id = "TT24_204", spp = "Mai", plot = 3, subplot = 35,
                   doy = 233, t(coef(mai_TT24_204_233)),
                   leaf_length_cm = 14.1, stem_length_cm = 40.2)

# TT24_201
mai_TT24_201_233 <- subset(li6800_merged, id == "TT24_201" & doy == 233) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_201_233)

aci_coefs[857, ] <- c(id = "TT24_201", spp = "Mai", plot = 3, subplot = 35,
                   doy = 233, t(coef(mai_TT24_201_233)),
                   leaf_length_cm = 9.6, stem_length_cm = 25.1)

# 5069
mai_5069_233 <- subset(li6800_merged, id == "5069" & doy == 233) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5069_233)

aci_coefs[858, ] <- c(id = "5069", spp = "Mai", plot = 3, subplot = 24,
                   doy = 233, t(coef(mai_5069_233)),
                   leaf_length_cm = 12.9, stem_length_cm = 35.6)

# 3643
mai_3643_233 <- subset(li6800_merged, id == "3643" & doy == 233) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_3643_233)

aci_coefs[859, ] <- c(id = "3643", spp = "Mai", plot = 3, subplot = 12,
                   doy = 233, t(coef(mai_3643_233)),
                   leaf_length_cm = 8.5, stem_length_cm = 17.9)

# TT24_212
mai_TT24_212_233 <- subset(li6800_merged, id == "TT24_212" & doy == 233) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_212_233)

aci_coefs[860, ] <- c(id = "TT24_212", spp = "Mai", plot = 3, subplot = 4,
                   doy = 233, t(coef(mai_TT24_212_233)),
                   leaf_length_cm = 16.9, stem_length_cm = 55.4)

# 9412
mai_9412_233 <- subset(li6800_merged, id == "9412" & doy == 233) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_9412_233)

aci_coefs[861, ] <- c(id = "9412", spp = "Mai", plot = 3, subplot = 3,
                   doy = 233, t(coef(mai_9412_233)),
                   leaf_length_cm = 16.1, stem_length_cm = 47.9)

# 4250
mai_4250_233 <- subset(li6800_merged, id == "4250" & doy == 233 & (A < 3 | A > 5) & (Ci < 550 | Ci > 1200)) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_4250_233)

aci_coefs[862, ] <- c(id = "4250", spp = "Mai", plot = 3, subplot = 2,
                   doy = 233, t(coef(mai_4250_233)),
                   leaf_length_cm = 12.9, stem_length_cm = 33.9)

# TT24_112
mai_TT24_112_233 <- subset(li6800_merged, id == "TT24_112" & doy == 233& (A < 2 | A > 6)) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_112_233)

aci_coefs[863, ] <- c(id = "TT24_112", spp = "Mai", plot = 3, subplot = 2,
                   doy = 233, t(coef(mai_TT24_112_233)),
                   leaf_length_cm = NA, stem_length_cm = 60.8)

# TT24_111
mai_TT24_111_233 <- subset(li6800_merged, id == "TT24_111" & doy == 233 & (A < 2 | A > 6)) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_111_233)

aci_coefs[864, ] <- c(id = "TT24_111", spp = "Mai", plot = 3, subplot = NA,
                   doy = 233, t(coef(mai_TT24_111_233)),
                   leaf_length_cm = 16.5, stem_length_cm = 59.7)

# 5184
mai_5184_233 <- subset(li6800_merged, id == "5184" & doy == 233 & (A < 2 | A > 6)) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5184_233)

aci_coefs[865, ] <- c(id = "5184", spp = "Mai", plot = 3, subplot = 13,
                   doy = 233, t(coef(mai_5184_233)),
                   leaf_length_cm = 16.0, stem_length_cm = 42.5)

#####################################################################
# 8/22/24: plot 6 (DOY = 235)
#####################################################################

# 4237
mai_4237_235 <- subset(li6800_merged, id == "4237" & doy == 235) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_4237_235)

aci_coefs[866, ] <- c(id = "4237", spp = "Mai", plot = 6, subplot = 32,
                      doy = 235, t(coef(mai_4237_235)),
                      leaf_length_cm = NA, stem_length_cm = NA)

# 5600
mai_5600_235 <- subset(li6800_merged, id == "5600" & doy == 235 & (A < 2 | A > 6)) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5600_235)

aci_coefs[867, ] <- c(id = "5600", spp = "Mai", plot = 6, subplot = 32,
                      doy = 235, t(coef(mai_5600_235)),
                      leaf_length_cm = NA, stem_length_cm = NA)

# TT24_160
mai_TT24_160_235 <- subset(li6800_merged, id == "TT24_160" & doy == 235) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_160_235)

aci_coefs[868, ] <- c(id = "TT24_160", spp = "Mai", plot = 6, subplot = 32,
                      doy = 235, t(coef(mai_TT24_160_235)),
                      leaf_length_cm = NA, stem_length_cm = NA)

# 5178
mai_5178_235 <- subset(li6800_merged, id == "5178" & doy == 235) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5178_235)

aci_coefs[869, ] <- c(id = "5178", spp = "Mai", plot = 6, subplot = 32,
                      doy = 235, t(coef(mai_5178_235)),
                      leaf_length_cm = NA, stem_length_cm = NA)

# 6448
mai_6448_235 <- subset(li6800_merged, id == "6448" & doy == 235) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_6448_235)

aci_coefs[870, ] <- c(id = "6448", spp = "Mai", plot = 6, subplot = 36,
                      doy = 235, t(coef(mai_6448_235)),
                      leaf_length_cm = NA, stem_length_cm = NA)

# 6462
mai_6462_235 <- subset(li6800_merged, id == "6462" & doy == 235) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_6462_235)

aci_coefs[871, ] <- c(id = "6462", spp = "Mai", plot = 6, subplot = 36,
                      doy = 235, t(coef(mai_6462_235)),
                      leaf_length_cm = NA, stem_length_cm = NA)

# 2743
mai_2743_235 <- subset(li6800_merged, id == "2743" & doy == 235) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_2743_235)

aci_coefs[872, ] <- c(id = "2743", spp = "Mai", plot = 6, subplot = 36,
                      doy = 235, t(coef(mai_2743_235)),
                      leaf_length_cm = NA, stem_length_cm = NA)

# TT24_232
mai_TT24_232_235 <- subset(li6800_merged, id == "TT24_232" & doy == 235 & (A < 2 | A > 6)) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_232_235)

aci_coefs[873, ] <- c(id = "TT24_232", spp = "Mai", plot = 6, subplot = 12,
                      doy = 235, t(coef(mai_TT24_232_235)),
                      leaf_length_cm = NA, stem_length_cm = NA)

# 6495
mai_6495_235 <- subset(li6800_merged, id == "6495" & doy == 235 & (A < 2 | A > 4)) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_6495_235)

aci_coefs[874, ] <- c(id = "6495", spp = "Mai", plot = 6, subplot = 25,
                      doy = 235, t(coef(mai_6495_235)),
                      leaf_length_cm = NA, stem_length_cm = NA)

# 1941
mai_1941_235 <- subset(li6800_merged, id == "1941" & doy == 235) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_1941_235)

aci_coefs[875, ] <- c(id = "1941", spp = "Mai", plot = 6, subplot = 19,
                      doy = 235, t(coef(mai_1941_235)),
                      leaf_length_cm = NA, stem_length_cm = NA)

# TT24_135
mai_TT24_135_235 <- subset(li6800_merged, id == "TT24_135" & doy == 235 & (A < 3 | A > 6) & (Ci < 625 | Ci > 1200)) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_135_235)

aci_coefs[876, ] <- c(id = "TT24_135", spp = "Mai", plot = 6, subplot = 20,
                      doy = 235, t(coef(mai_TT24_135_235)),
                      leaf_length_cm = NA, stem_length_cm = NA)

# TT24_150
mai_TT24_150_235 <- subset(li6800_merged, id == "TT24_150" & doy == 235) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_150_235)

aci_coefs[877, ] <- c(id = "TT24_150", spp = "Mai", plot = 6, subplot = 19,
                      doy = 235, t(coef(mai_TT24_150_235)),
                      leaf_length_cm = NA, stem_length_cm = NA)

# 6483
mai_6483_235 <- subset(li6800_merged, id == "6483" & doy == 235) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_6483_235)

aci_coefs[878, ] <- c(id = "6483", spp = "Mai", plot = 6, subplot = 19,
                      doy = 235, t(coef(mai_6483_235)),
                      leaf_length_cm = NA, stem_length_cm = NA)

# TT24_230
mai_TT24_230_235 <- subset(li6800_merged, id == "TT24_230" & doy == 235) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_230_235)

aci_coefs[879, ] <- c(id = "TT24_230", spp = "Mai", plot = 6, subplot = 29,
                      doy = 235, t(coef(mai_TT24_230_235)),
                      leaf_length_cm = NA, stem_length_cm = NA)

# TT24_206
mai_TT24_206_235 <- subset(li6800_merged, id == "TT24_206" & doy == 235) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_206_235)

aci_coefs[880, ] <- c(id = "TT24_206", spp = "Mai", plot = 6, subplot = 22,
                      doy = 235, t(coef(mai_TT24_206_235)),
                      leaf_length_cm = NA, stem_length_cm = NA)

# 3175
mai_3175_235 <- subset(li6800_merged, id == "3175" & doy == 235 & (Ci < 600 | Ci > 1000)) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_3175_235)

aci_coefs[881, ] <- c(id = "3175", spp = "Mai", plot = 6, subplot = 22,
                      doy = 235, t(coef(mai_3175_235)),
                      leaf_length_cm = NA, stem_length_cm = NA)

# 5567
mai_5567_235 <- subset(li6800_merged, id == "5567" & doy == 235) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5567_235)

aci_coefs[882, ] <- c(id = "5567", spp = "Mai", plot = 6, subplot = 22,
                      doy = 235, t(coef(mai_5567_235)),
                      leaf_length_cm = NA, stem_length_cm = NA)

#####################################################################
# 8/23/24: plot 6 (DOY = 236)
#####################################################################

# 4216
mai_4216_236 <- subset(li6800_merged, id == "4216" & doy == 236) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_4216_236)

aci_coefs[883, ] <- c(id = "4216", spp = "Mai", plot = 6, subplot = 11,
                   doy = 236, t(coef(mai_4216_236)),
                   leaf_length_cm = NA, stem_length_cm = NA)

# 3438
mai_3438_236 <- subset(li6800_merged, id == "3438" & doy == 236 & (Ci < 500 | Ci > 1100)) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_3438_236)

aci_coefs[884, ] <- c(id = "3438", spp = "Mai", plot = 6, subplot = 11,
                   doy = 236, t(coef(mai_3438_236)),
                   leaf_length_cm = NA, stem_length_cm = NA)

# 5025
mai_5025_236 <- subset(li6800_merged, id == "5025" & doy == 236 & Ci < 575 & (A < 3 | A > 6)) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5025_236)

aci_coefs[885, ] <- c(id = "5025", spp = "Mai", plot = 6, subplot = 11,
                   doy = 236, t(coef(mai_5025_236)),
                   leaf_length_cm = NA, stem_length_cm = NA)

# TT24_234
mai_TT24_234_236 <- subset(li6800_merged, id == "TT24_234" & doy == 236) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_234_236)

aci_coefs[886, ] <- c(id = "TT24_234", spp = "Mai", plot = 6, subplot = 11,
                   doy = 236, t(coef(mai_TT24_234_236)),
                   leaf_length_cm = NA, stem_length_cm = NA)

# 5664
mai_5664_236 <- subset(li6800_merged, id == "5664" & doy == 236) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5664_236)

aci_coefs[887, ] <- c(id = "5664", spp = "Mai", plot = 6, subplot = 9,
                   doy = 236, t(coef(mai_5664_236)),
                   leaf_length_cm = NA, stem_length_cm = NA)

# 5607
mai_5607_236 <- subset(li6800_merged, id == "5607" & doy == 236) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5607_236)

aci_coefs[888, ] <- c(id = "5607", spp = "Mai", plot = 6, subplot = 9,
                   doy = 236, t(coef(mai_5607_236)),
                   leaf_length_cm = NA, stem_length_cm = NA)

# TT24_131
mai_TT24_131_236 <- subset(li6800_merged, id == "TT24_131" & doy == 236 & Ci < 600 & (A < 3 | A > 6)) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
plot(mai_TT24_131_236)

aci_coefs[889, ] <- c(id = "TT24_131", spp = "Mai", plot = 6, subplot = 9,
                   doy = 236, t(coef(mai_TT24_131_236)),
                   leaf_length_cm = NA, stem_length_cm = NA)

# 3468
mai_3468_236 <- subset(li6800_merged, id == "3468" & doy == 236) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_3468_236)

aci_coefs[890, ] <- c(id = "3468", spp = "Mai", plot = 6, subplot = 9,
                   doy = 236, t(coef(mai_3468_236)),
                   leaf_length_cm = NA, stem_length_cm = NA)

# TT24_132
mai_5567_236 <- subset(li6800_merged, id == "TT24_132" & doy == 236 & (Ci < 650 | Ci > 1200)) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
plot(mai_5567_236)

aci_coefs[891, ] <- c(id = "TT24_132", spp = "Mai", plot = 6, subplot = 2,
                   doy = 236, t(coef(mai_5567_236)),
                   leaf_length_cm = NA, stem_length_cm = NA)

# 4722
mai_4722_236 <- subset(li6800_merged, id == "4722" & doy == 236) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_4722_236)

aci_coefs[892, ] <- c(id = "4722", spp = "Mai", plot = 6, subplot = 8,
                   doy = 236, t(coef(mai_4722_236)),
                   leaf_length_cm = NA, stem_length_cm = NA)

# 1495
mai_1495_236 <- subset(li6800_merged, id == "1495" & doy == 236) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_1495_236)

aci_coefs[893, ] <- c(id = "1495", spp = "Mai", plot = 6, subplot = 8,
                   doy = 236, t(coef(mai_1495_236)),
                   leaf_length_cm = NA, stem_length_cm = NA)

# 5009
mai_5009_236 <- subset(li6800_merged, id == "5009" & doy == 236) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5009_236)

aci_coefs[894, ] <- c(id = "5009", spp = "Mai", plot = 6, subplot = 8,
                   doy = 236, t(coef(mai_5009_236)),
                   leaf_length_cm = NA, stem_length_cm = NA)

# 1146
mai_1146_236 <- subset(li6800_merged, id == "1146" & doy == 236 & (A < 2 | A > 5)) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_1146_236)

aci_coefs[895, ] <- c(id = "1146", spp = "Mai", plot = 6, subplot = 8,
                   doy = 236, t(coef(mai_1146_236)),
                   leaf_length_cm = NA, stem_length_cm = NA)

# 5596
mai_5596_236 <- subset(li6800_merged, id == "5596" & doy == 236) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5596_236)

aci_coefs[896, ] <- c(id = "5596", spp = "Mai", plot = 6, subplot = 8,
                   doy = 236, t(coef(mai_5596_236)),
                   leaf_length_cm = NA, stem_length_cm = NA)

# TT24_130
mai_TT24_130_236 <- subset(li6800_merged, id == "TT24_130" & doy == 236) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_TT24_130_236)

aci_coefs[897, ] <- c(id = "TT24_130", spp = "Mai", plot = 6, subplot = 8,
                   doy = 236, t(coef(mai_TT24_130_236)),
                   leaf_length_cm = NA, stem_length_cm = NA)

# 2692
mai_2692_236 <- subset(li6800_merged, id == "2692" & doy == 236) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_2692_236)

aci_coefs[898, ] <- c(id = "2692", spp = "Mai", plot = 6, subplot = 21,
                   doy = 236, t(coef(mai_2692_236)),
                   leaf_length_cm = NA, stem_length_cm = NA)

# 5506
mai_5506_236 <- subset(li6800_merged, id == "5506" & doy == 236) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_5506_236)

aci_coefs[899, ] <- c(id = "5506", spp = "Mai", plot = 6, subplot = 21,
                   doy = 236, t(coef(mai_5506_236)),
                   leaf_length_cm = NA, stem_length_cm = NA)

#####################################################################
# 8/24/24: plot 5 (DOY = 237)
#####################################################################
# 631
mai_631_237 <- subset(li6800_merged, id == "631" & doy == 237) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_631_237)

aci_coefs[900, ] <- c(id = "631", spp = "Mai", plot = 5, subplot = 3,
                   doy = 237, t(coef(mai_631_237)),
                   leaf_length_cm = NA, stem_length_cm = NA)

# 3960
mai_3960_237 <- subset(li6800_merged, id == "3960" & doy == 237) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_3960_237)

aci_coefs[901, ] <- c(id = "3960", spp = "Mai", plot = 5, subplot = 3,
                   doy = 237, t(coef(mai_3960_237)),
                   leaf_length_cm = NA, stem_length_cm = NA)

# 3993
mai_3993_237 <- subset(li6800_merged, id == "3993" & doy == 237) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
# plot(mai_3993_237)

aci_coefs[902, ] <- c(id = "3993", spp = "Mai", plot = 5, subplot = 3,
                   doy = 237, t(coef(mai_3993_237)),
                   leaf_length_cm = NA, stem_length_cm = NA)

# 5657
mai_5657_237 <- subset(li6800_merged, id == "5657" & doy == 237) %>%
  fitaci(varnames = list(ALEAF = "A", Tleaf = "Tleaf", 
                         Ci = "Ci", PPFD = "Qin_cuvette"),
         fitTPU = TRUE, Tcorrect = FALSE)
plot(mai_5657_237)

aci_coefs[903, ] <- c(id = "5657", spp = "Mai", plot = 5, subplot = 23,
                      doy = 237, t(coef(mai_5657_237)),
                      leaf_length_cm = NA, stem_length_cm = NA)
...
aci_coefs[3:11] <- sapply(aci_coefs[3:11], as.numeric)

gm_photo <- aci_coefs %>%
  left_join(treatments, by = "subplot")
...
write.csv(snapshot, "../data/TT24_photo_snapshot.csv", row.names = F)
...
#####################################################################
# Visualize gm.trt effects
#####################################################################
# Anet 
ggplot(data = subset(total_photo, !is.na(gm.trt) & anet > 0), 
...
# Vcmax
ggplot(data = subset(total_photo, !is.na(gm.trt) & !is.na(spp)), 
       aes(x = gm.trt, y = Vcmax, fill = gm.trt)) +
  geom_boxplot(width = 0.5) +
  facet_grid(~spp) +
  theme_bw(base_size = 18)
...
# Jmax
ggplot(data = subset(total_photo, !is.na(gm.trt) & !is.na(spp)), 
       aes(x = gm.trt, y = Jmax, fill = gm.trt)) +
  geom_boxplot(width = 0.5) +
  facet_grid(~spp) +
  theme_bw(base_size = 18)
...
# Jmax:Vcmax
ggplot(data = subset(total_photo, !is.na(gm.trt) & !is.na(spp)), 
       aes(x = gm.trt, y = Jmax/Vcmax, fill = gm.trt)) +
  geom_boxplot(width = 0.5) +
  facet_grid(~spp) +
  theme_bw(base_size = 18)

#####################################################################
# Visualize gm.trt effects across growing season
#####################################################################
...
# Jmax:Vcmax
ggplot(data = subset(total_photo, !is.na(gm.trt) & !is.na(spp)), 
       aes(x = doy, y = Jmax/Vcmax, fill = gm.trt)) +
  geom_point(size = 3, shape = 21) +
  facet_grid(~spp) +
  theme_bw(base_size = 18)
